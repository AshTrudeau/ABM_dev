...
# plot lake locations and angler locations
...
# 
# ggplot()+
#   geom_polygon(data=wi, aes(x=long, y=lat, group=group), fill="gray")+
#   geom_point(data=lakeCharacteristics, aes(x=lakeLong, y=lakeLat, size=areaHa), color="blue")+
#   geom_point(data=anglerCharacteristics, aes(x=anglerLong, y=anglerLat), shape=4)+
#   theme_bw()
# ggsave(here::here("figures","map.lakes.anglers.png"), height=6, width=7)
